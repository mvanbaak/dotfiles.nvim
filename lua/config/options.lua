-- ================================================================================================
-- TITLE : options
-- ABOUT : Options / Settings native to (neo)vim
-- ================================================================================================
...
vim.opt.spelllang = { "en", "pt", "nl" } -- Set language for spellchecking
...
-- Visual Settings
vim.opt.background = "dark" -- Tell vim we have a dark background
vim.opt.termguicolors = true -- Enable 24-bit colors
vim.opt.signcolumn = "yes" -- Always show sign column
vim.opt.showmatch = true -- Highlight matching brackets
vim.opt.matchtime = 2 -- How long to show matching bracket
vim.opt.completeopt = "menuone,noinsert,noselect" -- Completion options
-- vim.opt.completeopt = 'fuzzy,menuone,noselect,preview' -- Completion options
...
vim.opt.modeline = true -- Read modeline
vim.opt.modelines = 5 -- Number of lines to check for a modeline
...
-- Disable some neovim language interpreters
vim.g.loaded_node_provider = 0 -- Disable node.js support
vim.g.loaded_perl_provider = 0 -- Disable pers support
